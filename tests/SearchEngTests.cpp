...
TEST(TestCaseSearchServer, TestSimple)
{
    ...
    const vector<vector<RelativeIndex>> expected = {{{2, 1}, {0, 0.7}, {1, 0.3}}, {}};
    InvertedIndex idx;
    ...
    vector<vector<RelativeIndex>> result = srv.search(request, 5);
    ASSERT_EQ(result, expected);
}
...
TEST(TestCaseSearchServer, TestTop5)
{
    ...
    const vector<vector<RelativeIndex>> expected = {{{7, 1}, {14, 1}, {0, 0.666666687}, {1, 0.666666687}, {2, 0.666666687}}};
    InvertedIndex idx;
